...
cdef class BatchedDataset:
    ...
    cdef public cnumpy.ndarray counts
    ...
    def _mk_weights(self, cnumpy.ndarray[cnumpy.int64_t, ndim=2] idx, cnumpy.ndarray[cnumpy.double_t, ndim=1] weights):
        cdef int i
        cdef long t, h
        cdef set Tl, Th
        cdef cnumpy.ndarray[cnumpy.int64_t, ndim=1] A
        cdef cnumpy.ndarray[cnumpy.double_t, ndim=1] S
